        ...
        <nav className="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <SidebarLinkGroup
                activeCondition={pathname.includes('reservation')}
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
              ...
              {/* <!-- Menu Item Carreer --> */}
              <SidebarLinkGroup activeCondition={pathname.includes('carreer')}>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      {rol === 'librarian' && (
